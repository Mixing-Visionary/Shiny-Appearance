...
import ru.visionary.mixing.shiny_appearance.presentation.viewmodel.FollowingViewModel
    ...
    Column(
        ...
        LazyColumn(
            ...
            items(follows) { follow ->
                FollowingItem(
                    nick = follow.nickname,
                    onClick = {
                        viewModel.followUserDelete(follow.userId, onSuccess = {
                            viewModel.refreshFollows()
                        })
                    },
                )
