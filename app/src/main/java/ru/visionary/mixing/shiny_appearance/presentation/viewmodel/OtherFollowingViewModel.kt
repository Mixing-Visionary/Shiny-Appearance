...
@HiltViewModel
class OtherFollowingViewModel @Inject constructor(
    ...
    fun loadNextPage(userId: Int) {
        ...
        viewModelScope.launch {
            val result = followRepository.getFollowsById(userId = userId, size = pageSize, page = currentPage)
